  ...
  table = $('#tagstable').DataTable({
    ...
    "columnDefs": [{
      ...
      "render": function (data, type, row, meta) {
        data = '<button class="btn btn-lg mr-3" style="background-color:#2D312C; color:#fff;" id="delete" onclick="deletetag()"><span class="fa fa-trash"></span></button><button class="btn btn-lg" style="background-color:#2D312C; color:#fff;" id="editbtn" data-toggle="modal" data-target="#editModal" onclick=editTagModel()><span class="fa fa-edit"></span></button>';
        return data;
      }
    }],
  });
        ...
        'Yes': {
          ...
          action: function () {
            ...
            request.addEventListener("load", function () {
              ...
              if (d == "true") {
                alert(obj.tagname + " Deleted")
              } else {
                alert(obj.tagname + " Filed to Deleted");
              }
              table.ajax.reload(null, false);
            })
